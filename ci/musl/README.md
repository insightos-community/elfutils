# libelf 0.194 musl release

Source-built Linux x86_64 musl shared libraries and development prefix.

Upstream: https://sourceware.org/elfutils/, tag elfutils-0.194.
...
Tag musl-v0.194-N publishes only after all checks pass. Published tags and assets are never overwritten.
